...
require_relative 'attempt/timeout'
require_relative 'attempt/strategies'
require_relative 'attempt/thread_timeout'
require_relative 'attempt/process_timeout'
require_relative 'attempt/detection'

# The Attempt class encapsulates methods related to multiple attempts at
# running the same method before actually failing.
class Attempt
  include AttemptStrategies
